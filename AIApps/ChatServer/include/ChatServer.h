...
private:
	...
	friend class ChatNewSessionHandler;
	friend class ChatSessionsHandler;
	friend class ChatSpeechHandler;
	friend class KbPageHandler;
	friend class KbListHandler;
	friend class KbUploadHandler;
	friend class KbSearchHandler;
